...
function MCVariantSpatial({ width = 1440, height = 920, palette: paletteOverride, density: densityOverride, vizMode: vizModeOverride, live = false }) {
  ...
  return (
    <div data-screen-label="V3 · Holographic Spatial" style={{
      ...
      <SpatialPanel style={{
        ...
        <SpatialPanelHeader title="Live viewport" subtitle="tap any element to heal"
          accent={healing ? palette.anomaly : null} palette={palette} />
