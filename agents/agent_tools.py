...
def _self_correct(agent, result: dict) -> dict:
    ...
    _jtrace(f"[TRACE] agents.agent_tools._self_correct: enter")
    ...
    try:
        ...
        _jtrace(f"[TRACE] agents.agent_tools._self_correct: except {str(e)[:80]}")
        ...
        try:
            ...
            _jtrace(f"[TRACE] agents.agent_tools._self_correct: except Exception")
            pass
...
def run_backend_agent(task: str, user_id: str | None = None) -> str:
    ...
    _jtrace(f"[TRACE] agents.agent_tools.run_backend_agent: enter")
    ...
    try:
        ...
        _jtrace(f"[TRACE] agents.agent_tools.run_backend_agent: except {str(e)[:80]}")
...
def run_frontend_agent(task: str, user_id: str | None = None) -> str:
    ...
    _jtrace(f"[TRACE] agents.agent_tools.run_frontend_agent: enter")
    ...
    try:
        ...
        _jtrace(f"[TRACE] agents.agent_tools.run_frontend_agent: except {str(e)[:80]}")
...
def run_qa_agent(task: str, user_id: str | None = None) -> str:
    ...
    _jtrace(f"[TRACE] agents.agent_tools.run_qa_agent: enter")
    ...
    try:
        ...
        _jtrace(f"[TRACE] agents.agent_tools.run_qa_agent: except {str(e)[:80]}")
...
def run_iac_agent(task: str) -> str:
    ...
    _jtrace(f"[TRACE] agents.agent_tools.run_iac_agent: enter")
    ...
    try:
        ...
        _jtrace(f"[TRACE] agents.agent_tools.run_iac_agent: except {str(e)[:80]}")
...
def select_skill_for(task: str) -> str | None:
    ...
    _jtrace(f"[TRACE] agents.agent_tools.select_skill_for: enter")
    try:
        ...
        _jtrace(f"[TRACE] agents.agent_tools.select_skill_for: except {str(e)[:80]}")
...
def run_skill_agent(skill_name: str, task: str, user_id: str | None = None) -> str:
    ...
    try:
        ...
        _jtrace(f"[TRACE] agents.agent_tools.run_skill_agent: except {str(e)[:80]}")
...
def run_engineering_agent(task: str, user_id: str | None = None) -> str:
    ...
    _jtrace(f"[TRACE] agents.agent_tools.run_engineering_agent: enter")
...
def run_skill(skill_name: str, task: str, model: str | None = None) -> str:
    ...
    try:
        ...
        _jtrace(f"[TRACE] agents.agent_tools.run_skill: except {str(e)[:80]}")
