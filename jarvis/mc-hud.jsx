...
function MCVariantHUD({ width = 1440, height = 920, palette: paletteOverride, density: densityOverride, vizMode: vizModeOverride }) {
  ...
  return (
    <div data-screen-label="V1 · HUD Cinematic" style={{
      ...
      {/* ── Header ─────────────────────────────────────── */}
      <HudHeader palette={palette} telemetry={mc.telemetry} taskStatus={mc.taskStatus} />
      ...
      <div style={{
        ...
        <HudFramePanel label="03 · LIVE VIEWPORT · tap to heal" palette={palette}>
...
// ─── HUD primitives ──────────────────────────────────────
function HudHeader({ palette, telemetry, taskStatus }) {
  return (
    <div style={{
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
        ...
        <div>
          ...
          }}>MISSION CONTROL · HERMES v2.6 · LOCAL</div>
        </div>
      </div>
      <div style={{ flex: 1 }} />
